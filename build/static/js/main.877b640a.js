/*! For license information please see main.877b640a.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      463: (e, n, t) => {
        ...
        function Ae(e, n, t, r, l, a, o, u, i) {
          (Fe = !1), (Ie = null), De.apply(Be, arguments);
        }
        function Ve(e) {
          var n = e,
            t = e;
        ...
        function Vr(e) {
          if (!e[Ar]) {
            ...
            null === n || n[Ar] || ((n[Ar] = !0), Br("selectionchange", !1, n));
          }
        }
        function $r(e, n, t, r) {
          switch (Xn(n)) {
            ...
            if (0 === (7 & n)) {
              ...
              b &&
                ...
                (y = Ft
                  ...
                  : (function (e, n) {
                      if (Vt)
                        return "compositionend" === e || (!Mt && Bt(e, n))
        ...
        var Aa = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = Ma(e, a, l)) && (rs(n, e, l, r), Da(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = Ma(e, l, r)) && (rs(n, e, r, t), Da(n, e, r));
          },
        };
        ...
        function Wa(e, n, t, r) {
          ...
          "object" === typeof a && null !== a
            ? (l.context = Ca(a))
            : ((a = Ll(n) ? Tl : Nl.current), (l.context = Rl(e, a))),
          ...
          if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
            return (function (e, n, t, r, l, o, u) {
              ...
              if (((i = 0 !== (u & e.childLanes)), wu || i)) {
                ...
                return vs(), Bu(e, n, u, (r = fu(Error(a(421)))));
              }
              return "$?" === l.data
                ? ((n.flags |= 128),
                  (n.child = e.child),
        ...
        function Ku(e, n, t) {
          ...
          switch ((na(n), n.tag)) {
            ...
            case 5:
              ...
              if (((t = n.type), null !== e && null != n.stateNode))
                ...
                if (((e = to(Ja.current)), fa(n))) {
                  ...
                  switch (
                    ...
                    case "video":
                    case "audio":
                      for (l = 0; l < Dr.length; l++) jr(Dr[l], r);
                      break;
                    case "source":
                      jr("error", r);
                      break;
                  ...
                  e: {
                    switch (((i = be(t, r)), t)) {
                      ...
                      case "video":
                      case "audio":
                        for (l = 0; l < Dr.length; l++) jr(Dr[l], e);
                        l = r;
                        break;
                      case "source":
                        jr("error", e), (l = r);
              ...
              return qu(n), null;
            case 6:
              if (e && null != n.stateNode) Du(e, n, e.memoizedProps, r);
              else {
        ...
        function as(e, n) {
          ...
          if (0 !== n) {
            if (
              ...
              throw ((t = Fi), ps(e, 0), is(e, r), ls(e, Xe()), t);
            if (6 === n) is(e, r);
            else {
              if (
        ...
        function gs(e, n) {
          ...
          if ((ka(), (zi = t), (_i.current = r), null !== Ri))
            throw Error(a(261));
          return (Ti = null), (Li = 0), Di;
        }
        function ys() {
          for (; null !== Ri; ) ws(Ri);
        }
        function bs() {
          for (; null !== Ri && !Ye(); ) ws(Ri);
        }
        function ws(e) {
        ...
        function ks(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 === (32768 & n.flags))) {
              if (null !== (t = Ku(t, n, Oi))) return void (Ri = t);
            } else {
              if (null !== (t = Yu(t, n)))
                return (t.flags &= 32767), void (Ri = t);
              if (null === e) return (Di = 6), void (Ri = null);
        ...
        function _s(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            Ti === e &&
              (Li & t) === t &&
              (4 === Di ||
              (3 === Di && (130023424 & Li) === Li && 500 > Xe() - Vi)
                ? ps(e, 0)
                : (ji |= t)),
            ls(e, n);
        }
        ...
        function Hs(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = Ma(l, n, o)) && (rs(e, l, o, a), Da(e, l, o)),
            o
          );
        }
        function Ws(e) {
  ...
  (t.m = e),
    ...
    (t.u = (e) => "static/js/" + e + ".e1f2d413.chunk.js"),
    (t.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var n = (n, r) => {
        ...
        r = (self.webpackChunkmicro_react = self.webpackChunkmicro_react || []);
      r.forEach(n.bind(null, 0)), (r.push = n.bind(null, r.push.bind(r)));
    })(),
    (() => {
      var e = t(791),
        n = t(250);
      const r = t.p + "static/media/logo.6ce24c58023cc2f8fd88fe9d219db6c6.svg";
      var l = t(184);
      const a = function () {
          return (0, l.jsx)("div", {
            className: "App",
        ...
        if (
          ...
          typeof (t = n.domElement
            ...
            : (function (e) {
                ...
                var t = "single-spa-application:".concat(n);
                return function () {
          ...
          throw Error(
            "single-spa's dom-element-getter-helpers was given an invalid domElementGetter for application or parcel '"
              .concat(n.name, "'. Expected a function, received ")
              .concat(f(t))
          );
        return function () {
          var e = t(n);
          if (!(e instanceof HTMLElement))
            throw Error(
              "single-spa's dom-element-getter-helpers: domElementGetter returned an invalid dom element for application or parcel '"
                .concat(n.name, "'. Expected HTMLElement, received ")
                .concat(f(e))
            );
          return e;
        };
      ...
      function h(e, n) {
        return e.rootComponent
          ? Promise.resolve()
          : e.loadRootComponent(n).then(function (n) {
              e.rootComponent = n;
            });
      }
      function v(e, n) {
        return new Promise(function (t, r) {
          e.suppressComponentDidCatchWarning ||
            !(function (e) {
              if (
                ...
                return !1;
              var n = e.version.slice(0, e.version.indexOf("."));
              try {
                return Number(n) >= 16;
              } catch (e) {
                return !1;
              ...
              ? e.rootComponent.prototype.componentDidCatch ||
                console.warn(
                  "single-spa-react: ".concat(
                    n.name || n.appName || n.childAppName,
          ...
          var l = k(e, n, function () {
            ...
            o = (function (e) {
              ...
              if ("function" != typeof l)
                throw new Error(
                  'renderType "'.concat(n, '" did not return a function.')
                );
              switch (n) {
                case "createRoot":
          ...
          (e.domElements[n.name] = a), (e.renderResults[n.name] = o);
        });
      }
      function g(e, n) {
        return new Promise(function (t) {
          e.unmountResolves[n.name] = t;
          var r = e.renderResults[n.name];
          r && r.unmount
            ? r.unmount()
            : b(e).unmountComponentAtNode(e.domElements[n.name]),
            delete e.domElements[n.name],
            delete e.renderResults[n.name];
        });
      }
      function y(e, n) {
        return new Promise(function (t) {
          e.updateResolves[n.name] || (e.updateResolves[n.name] = []),
            e.updateResolves[n.name].push(t);
          var r = k(e, n, null),
            l = e.renderResults[n.name];
          if (l && l.render) l.render(r);
          else {
            var a = d(e, n)();
            b(e).render(r, a);
          }
      ...
      function w(e) {
        return "function" == typeof e.renderType
          ? e.renderType()
          : e.renderType;
      }
      function k(e, n, t) {
        var r = e.React.createElement(e.rootComponent, n),
          l = p ? e.React.createElement(p.Provider, { value: n }, r) : r;
        return (
          (e.errorBoundary ||
            n.errorBoundary ||
            e.errorBoundaryClass ||
            ...
            ((e.errorBoundaryClass =
              ...
              (function (e, n) {
                ...
                return (
                  (t.prototype = Object.create(e.React.Component.prototype)),
                  (t.prototype.render = function () {
                    return this.state.caughtError
                      ? (e.errorBoundary || n.errorBoundary)(
                  ...
                  (t.prototype.componentDidCatch = function (e, n) {
                    this.setState({ caughtError: e, caughtErrorInfo: n });
                  }),
                  t
                );
              })(e, n)),
            (l = e.React.createElement(e.errorBoundaryClass, n, l))),
            ...
            i(
              ...
              {},
              {
                ...
                updateFinished: function () {
                  e.updateResolves[n.name] &&
                    (e.updateResolves[n.name].forEach(function (e) {
                      return e();
                    }),
                    delete e.updateResolves[n.name]);
                },
                unmountFinished: function () {
                  e.unmountResolves[n.name] &&
                    (e.unmountResolves[n.name](),
                    delete e.unmountResolves[n.name]);
                },
              }
            ),
            l
      ...
      const {
        ...
        if (!n.ReactDOM && !n.ReactDOMClient)
          throw new Error(
        ...
        !p && n.React.createContext && (p = n.React.createContext()),
          (n.SingleSpaRoot = (function (e) {
            function n(e) {
              n.displayName = "SingleSpaRoot(".concat(e.name, ")");
            }
            return (
              (n.prototype = Object.create(e.React.Component.prototype)),
              ...
              (n.prototype.render = function () {
                return (
                  setTimeout(this.props.updateFinished), this.props.children
                );
              }),
              n
            );
        ...
        var t = {
          bootstrap: h.bind(null, n),
          mount: v.bind(null, n),
          unmount: g.bind(null, n),
        };
        return n.parcelCanUpdate && (t.update = y.bind(null, n)), t;
      })({
        React: e,
        ReactDOM: n,
        App: a,
        errorBoundary: (e, n, t) =>
          (0, l.jsx)("div", {
            children: "This renders when a catastrophic error occurs",
          }),
      });
      o();
    })();
})();
//# sourceMappingURL=main.877b640a.js.map
